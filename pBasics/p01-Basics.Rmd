...
```{r 'P01I01', include=FALSE, fig.cap="This-Caption-NOT-Shown"}
include_graphics(here("images", "P01I01-Kite.png"))
```


```{r 'P01-Plot-Kite-02', include=FALSE}
set.seed(3)
# #Get specific layout coordinates in a Matrix using Fruchterman-Reingold
hh <- kite
# #Layout: Fruchterman Reingold or Kamada Kawai
lay_hh <- layout_with_fr(hh) #layout_with_kk(hh) layout_with_fr(hh)
# #Use Degrees of each node to indicate size
size_hh <- degree(hh, mode = "all") * 5
#
ttl_hh <- "Krackhardt Kite: Degrees denoted by Size" 
cap_hh <- "P01I02"
loc_png <- here("images", "P01I02-Kite-Degree.png") 
#
if(!file.exists(loc_png)) {
  png(filename = loc_png, width = q_png_w, height = q_png_h, units = "in", res = q_dpi)
  #dev.control('enable') 
  plot(hh, layout = lay_hh, vertex.size = size_hh)
  title(main = ttl_hh, line = 3, adj = 0)
  title(sub = cap_hh, line = 4, adj = 1)
  P01 <- recordPlot()
  dev.off()
...
```{r 'P01I02', include=FALSE, fig.cap="This-Caption-NOT-Shown"}
include_graphics(here("images", "P01I02-Kite-Degree.png"))
```

```{r 'P01-Plot-Kite-03', include=FALSE}
set.seed(3)
hh <- kite
# #Layout: Fruchterman Reingold or Kamada Kawai
lay_hh <- layout_with_fr(hh) #layout_with_kk(hh) layout_with_fr(hh)
...
away_d <- distances(hh, v = V(bb)["D"], to = V(hh))
...
#
ttl_hh <- "Krackhardt Kite: Distances from D" 
cap_hh <- "P01I03"
loc_png <- here("images", "P01I03-Kite-Degree-D.png") 
#
if(!file.exists(loc_png)) {
  png(filename = loc_png, width = q_png_w, height = q_png_h, units = "in", res = q_dpi)
  #dev.control('enable') 
...
```{r 'P01I03', include=FALSE, fig.cap="This-Caption-NOT-Shown"}
include_graphics(here("images", "P01I03-Kite-Degree-D.png"))
```

```{r 'P01I010203', echo=FALSE, out.width='33%', ref.label=c('P01I01', 'P01I02', 'P01I03'), fig.cap="(P01I01 P01I02 P01I03) Krackhardt Kite"}
#
```

#### Code {.unlisted .unnumbered}

```{r 'P01-Plot-Kite-01-A', eval=FALSE, ref.label=c('P01-Plot-Kite-01')}
#
```

```{r 'P01-Plot-Kite-02-A', eval=FALSE, ref.label=c('P01-Plot-Kite-02')}
#
```

```{r 'P01-Plot-Kite-03-A', eval=FALSE, ref.label=c('P01-Plot-Kite-03')}
#
```
