...
```{r 'P01-R-iGraph-Kite-builtin', decorate=TRUE}
# #Use Dataset Provided with igraph package
bb <- make_graph("Krackhardt kite")
# #Assign Letters
V(bb)$name <- LETTERS[1:vcount(bb)]
# #Verify Edgelist between Pacakge Data and CSV
stopifnot(identical(attributes(E(bb))$vnames, attributes(E(kite_u))$vnames))
attributes(V(bb))
attributes(E(bb))
