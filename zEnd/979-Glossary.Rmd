...
```{r '979-R-Theorems', comment="", echo=FALSE, results='asis', cache=FALSE}
...
```{r '979-R-Definitions', comment="", echo=FALSE, results='asis', cache=FALSE}
# #New items will NOT be added immediately if cache=TRUE
...
```{r '979-R-Errors', comment="", echo=FALSE, results='asis', cache=FALSE}
# #New items will NOT be added immediately if cache=TRUE
...
```{r 'l979-R-Validation', cache=FALSE}
